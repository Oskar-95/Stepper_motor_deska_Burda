...
extern "C" void app_main(void)
{
    ...
    // gpio_set_level(VCC_IO_1, 0); // vypnuti napajeni do driveru1
    // gpio_set_level(VCC_IO_2, 0); // vypnuti napajeni do driveru2
    // gpio_set_level(VCC_IO_3, 0); // vypnuti napajeni do driveru3 
    ...
    gpio_set_level(VCC_IO_0, 1);              //zapíná VCC_IO driveru 0
